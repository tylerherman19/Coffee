...
import { drinkLabels, loadCoffeeData, shopDrink, type CoffeeData, type Item, type Modifier, type Shop } from '@/lib/coffee-data';
...
export default function Home() {
  const [data, setData] = useState<CoffeeData>({ shops: [], items: [], modifiers: [], loadedAt: null });
